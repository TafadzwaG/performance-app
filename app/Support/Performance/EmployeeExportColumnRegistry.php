...
class EmployeeExportColumnRegistry
{
    public static function columns(): Collection
    {
        return collect([
            ...
            ['key' => 'location_id', 'label' => 'Primary Location', 'section' => 'employment', 'default' => true, 'required' => false],
    ...
    public static function value(EmployeeProfile $profile, string $key): mixed
    {
        ...
        return match ($key) {
            ...
            'location_id' => $profile->location ? "{$profile->location->name} ({$profile->location->code})" : null,
