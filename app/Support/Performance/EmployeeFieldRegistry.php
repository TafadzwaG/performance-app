...
class EmployeeFieldRegistry
{
    ...
    public static function definitions(): array
    {
        return [
            ...
            'national_id' => ['label' => 'National ID', 'section' => 'identity', 'input_type' => 'text', 'attribute' => 'national_id', 'allowed_screens' => [self::SCREEN_COMPLETE_PROFILE, self::SCREEN_EMPLOYEE_CREATE, self::SCREEN_EMPLOYEE_EDIT, self::SCREEN_EMPLOYEE_INDEX, self::SCREEN_EMPLOYEE_SHOW], 'configurable' => true],
            'date_of_birth' => ['label' => 'Date of Birth', 'section' => 'identity', 'input_type' => 'date', 'attribute' => 'date_of_birth', 'allowed_screens' => [self::SCREEN_COMPLETE_PROFILE, self::SCREEN_EMPLOYEE_CREATE, self::SCREEN_EMPLOYEE_EDIT, self::SCREEN_EMPLOYEE_SHOW], 'configurable' => true],
            'gender' => ['label' => 'Gender', 'section' => 'identity', 'input_type' => 'select', 'attribute' => 'gender', 'options_key' => 'genderOptions', 'allowed_screens' => [self::SCREEN_COMPLETE_PROFILE, self::SCREEN_EMPLOYEE_CREATE, self::SCREEN_EMPLOYEE_EDIT, self::SCREEN_EMPLOYEE_SHOW], 'configurable' => true],
            'marital_status' => ['label' => 'Marital Status', 'section' => 'identity', 'input_type' => 'select', 'attribute' => 'marital_status', 'options_key' => 'maritalStatusOptions', 'allowed_screens' => [self::SCREEN_COMPLETE_PROFILE, self::SCREEN_EMPLOYEE_CREATE, self::SCREEN_EMPLOYEE_EDIT, self::SCREEN_EMPLOYEE_SHOW], 'configurable' => true],
            'personal_phone' => ['label' => 'Personal Phone', 'section' => 'contact', 'input_type' => 'phone', 'attribute' => 'personal_phone', 'allowed_screens' => [self::SCREEN_COMPLETE_PROFILE, self::SCREEN_EMPLOYEE_CREATE, self::SCREEN_EMPLOYEE_EDIT, self::SCREEN_EMPLOYEE_SHOW], 'configurable' => true],
            'home_address_line_1' => ['label' => 'Address Line 1', 'section' => 'contact', 'input_type' => 'text', 'attribute' => 'home_address_line_1', 'allowed_screens' => [self::SCREEN_COMPLETE_PROFILE, self::SCREEN_EMPLOYEE_CREATE, self::SCREEN_EMPLOYEE_EDIT, self::SCREEN_EMPLOYEE_SHOW], 'configurable' => true],
            'home_address_line_2' => ['label' => 'Address Line 2', 'section' => 'contact', 'input_type' => 'text', 'attribute' => 'home_address_line_2', 'allowed_screens' => [self::SCREEN_COMPLETE_PROFILE, self::SCREEN_EMPLOYEE_CREATE, self::SCREEN_EMPLOYEE_EDIT, self::SCREEN_EMPLOYEE_SHOW], 'configurable' => true],
            'city' => ['label' => 'City', 'section' => 'contact', 'input_type' => 'text', 'attribute' => 'city', 'allowed_screens' => [self::SCREEN_COMPLETE_PROFILE, self::SCREEN_EMPLOYEE_CREATE, self::SCREEN_EMPLOYEE_EDIT, self::SCREEN_EMPLOYEE_SHOW], 'configurable' => true],
            'state_province' => ['label' => 'State / Province', 'section' => 'contact', 'input_type' => 'text', 'attribute' => 'state_province', 'allowed_screens' => [self::SCREEN_COMPLETE_PROFILE, self::SCREEN_EMPLOYEE_CREATE, self::SCREEN_EMPLOYEE_EDIT, self::SCREEN_EMPLOYEE_SHOW], 'configurable' => true],
            'postal_code' => ['label' => 'Postal Code', 'section' => 'contact', 'input_type' => 'text', 'attribute' => 'postal_code', 'allowed_screens' => [self::SCREEN_COMPLETE_PROFILE, self::SCREEN_EMPLOYEE_CREATE, self::SCREEN_EMPLOYEE_EDIT, self::SCREEN_EMPLOYEE_SHOW], 'configurable' => true],
            'country' => ['label' => 'Country', 'section' => 'contact', 'input_type' => 'select', 'attribute' => 'country', 'options_key' => 'countryOptions', 'allowed_screens' => [self::SCREEN_COMPLETE_PROFILE, self::SCREEN_EMPLOYEE_CREATE, self::SCREEN_EMPLOYEE_EDIT, self::SCREEN_EMPLOYEE_SHOW], 'configurable' => true],
            'emergency_contact_name' => ['label' => 'Emergency Contact Name', 'section' => 'contact', 'input_type' => 'text', 'attribute' => 'emergency_contact_name', 'allowed_screens' => [self::SCREEN_COMPLETE_PROFILE, self::SCREEN_EMPLOYEE_CREATE, self::SCREEN_EMPLOYEE_EDIT, self::SCREEN_EMPLOYEE_SHOW], 'configurable' => true],
            'emergency_contact_phone' => ['label' => 'Emergency Contact Phone', 'section' => 'contact', 'input_type' => 'phone', 'attribute' => 'emergency_contact_phone', 'allowed_screens' => [self::SCREEN_COMPLETE_PROFILE, self::SCREEN_EMPLOYEE_CREATE, self::SCREEN_EMPLOYEE_EDIT, self::SCREEN_EMPLOYEE_SHOW], 'configurable' => true],
            ...
            'notes' => ['label' => 'Notes', 'section' => 'notes', 'input_type' => 'textarea', 'attribute' => 'notes', 'allowed_screens' => [self::SCREEN_COMPLETE_PROFILE, self::SCREEN_EMPLOYEE_CREATE, self::SCREEN_EMPLOYEE_EDIT, self::SCREEN_EMPLOYEE_SHOW], 'configurable' => true],
