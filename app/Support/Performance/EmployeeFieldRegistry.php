...
class EmployeeFieldRegistry
{
    ...
    public static function definitions(): array
    {
        return [
            ...
            'location_id' => ['label' => 'Primary Location', 'section' => 'employment', 'input_type' => 'select', 'attribute' => 'location_id', 'options_key' => 'locationOptions', 'allowed_screens' => [self::SCREEN_EMPLOYEE_CREATE, self::SCREEN_EMPLOYEE_EDIT, self::SCREEN_EMPLOYEE_INDEX, self::SCREEN_EMPLOYEE_SHOW], 'configurable' => true],
    ...
    public static function defaults(): array
    {
        return [
            ...
            self::SCREEN_EMPLOYEE_CREATE => [
                ...
                'department_id' => ['enabled' => true, 'required' => true],
                'location_id' => ['enabled' => true, 'required' => true],
                'job_title_id' => ['enabled' => true, 'required' => true],
            ...
            self::SCREEN_EMPLOYEE_INDEX => [
                ...
                'location_id' => ['enabled' => true, 'required' => false],
