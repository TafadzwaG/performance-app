...
return [
    ...
    'notifications' => [
        ...
        'mail' => [
            'to' => env('DR_NOTIFICATION_EMAIL', env('MAIL_FROM_ADDRESS', 'hello@example.com')),
    ...
    'cleanup' => [
        ...
        'default_strategy' => [
             ...
             */
            'keep_all_backups_for_days' => env('DR_KEEP_DAILY_BACKUPS', 7),
             ...
             */
            'keep_daily_backups_for_days' => env('DR_KEEP_DAILY_BACKUPS', 7),
             ...
             */
            'keep_weekly_backups_for_weeks' => env('DR_KEEP_WEEKLY_BACKUPS', 4),

            /*
             * After the "keep_weekly_backups_for_weeks" period is over, the most recent backup
             * of that month will be kept. Older backups within the same month will be removed.
             */
            'keep_monthly_backups_for_months' => env('DR_KEEP_MONTHLY_BACKUPS', 12),
