...
export default function JobTitleCreate() {
    const { data, setData, post, processing, errors } = useForm<{ name: string; code: string; description: string; is_active: boolean }>({
        name: '',
        code: '',
        description: '',
        is_active: true,
    ...
    return (
        <PerformancePage title="Create Job Title" description="Add a job title for employee setup and templates." breadcrumbs={breadcrumbs}>
            <Card>
