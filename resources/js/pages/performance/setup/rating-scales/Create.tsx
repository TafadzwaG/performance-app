...
export default function RatingScaleCreate() {
    const { data, setData, post, processing, errors } = useForm<RatingScaleForm>({
        name: '',
        code: '',
    ...
    return (
        <PerformancePage
            ...
            description="Add a scoring scale and define the ordered rating levels behind it."
                ...
                <div className="rounded-2xl border bg-background p-6 shadow-sm">
                    <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
                        <div className="space-y-3">
                            ...
                            <div>
                                <h1 className="text-3xl font-bold tracking-tight text-foreground">Create Rating Scale</h1>
                                <p className="mt-2 max-w-2xl text-sm leading-6 text-muted-foreground">
                                    Build a rating scale used for objective scoring, competency scoring, or overall performance mapping.
                                </p>
                            </div>
                        </div>
                                ...
                                <div className="flex items-center justify-between gap-4">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <CardDescription>
                                                Capture the scale name, code, applies-to type, and descriptive context.
                                            </CardDescription>
                                        </div>
                                    </div>
                                ...
                                <div className="grid gap-6 md:grid-cols-2">
                                    <div className="space-y-2">
                                        ...
                                        <Input
                                            ...
                                            placeholder="e.g. Business Objectives 5 Point"
                                        />
                                    ...
                                    <div className="space-y-2 md:col-span-2">
                                        ...
                                        <textarea
                                            ...
                                            placeholder="Describe where this scale should be used and how managers should interpret it..."
                                        />
                                ...
                                <div className="flex items-center justify-between gap-4">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <CardDescription>
                                                Define ordered levels, numeric values, optional percentage bands, and a default selection.
                                            </CardDescription>
                                        </div>
                                    </div>
                            ...
                            <CardHeader className="border-b bg-muted/20">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <CardDescription>
                                            Control whether this scale is available to templates and scoring flows.
                                        </CardDescription>
                                    </div>
                                </div>
                            </CardHeader>
                            ...
                            <CardContent className="p-6">
                                <div className="flex items-center justify-between rounded-lg border bg-muted/10 p-4">
                                    <div className="space-y-1">
                                        ...
                                        <p className="text-xs text-muted-foreground">
                                            Should this scale be available for immediate assignment and scoring?
                                        </p>
                                    </div>
                    ...
                    <div className="col-span-12 space-y-6 lg:col-span-4">
                        <Card className="shadow-sm">
                            ...
                            <CardContent className="space-y-4 text-sm text-muted-foreground">
                                <p className="leading-6">
                                    Keep values simple and ordered. If percentage bands are used, make them non-overlapping and intuitive for score mapping.
                                </p>

                                <div className="flex items-start gap-3 rounded-lg border bg-muted/10 p-3">
                                    <Info className="mt-0.5 h-4 w-4 shrink-0" />
                                    <p className="text-xs leading-5">
                                        One default level is enough. It should reflect the most neutral starting point for the scale.
                                    </p>
                                </div>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="shadow-sm">
                            <CardHeader>
                                ...
                                <CardDescription>Live context for the scale you are building.</CardDescription>
                            </CardHeader>
                            ...
                            <CardContent className="space-y-4">
                                ...
                                <div>
                                    <span className="block text-2xl font-bold text-foreground">
                                        {data.levels.filter((level) => level.is_default).length}
                                    </span>
                                    <span className="text-[10px] uppercase tracking-widest text-muted-foreground">Default Levels</span>
                                </div>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="relative overflow-hidden shadow-sm">
                            ...
                            <CardContent className="space-y-3">
                                ...
                                <div className="mt-4 rounded-lg border bg-muted/20 p-4">
                                    <div className="flex items-center gap-2">
                                        <p className="text-sm font-semibold text-foreground">{data.name || 'Draft scale name'}</p>
                                        <Badge variant="outline">
                                            {typeOptions.find((option) => option.value === data.applies_to)?.label ?? 'Type'}
                                        </Badge>
                                    </div>
                                    <p className="mt-1 text-xs text-muted-foreground">{data.code || 'Draft scale code'}</p>
