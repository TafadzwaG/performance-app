                            ...
                            <tr key={rating.id}>
                                ...
                                <td className="p-2">
                                    {mode === 'manager' ? (
                                        <div className="space-y-2">
                                            <div>
                                                <div className="mb-1 text-xs font-medium text-muted-foreground">Employee comment</div>
                                                <textarea
                                                    className="min-h-16 w-full rounded-md border bg-muted/20 px-3 py-2 text-sm"
                                                    readOnly
                                                    value={rating.employee_comment ?? ''}
                                                />
                                            </div>
                                            <div>
                                                <div className="mb-1 text-xs font-medium text-muted-foreground">Manager comment</div>
                                                <textarea
                                                    className="min-h-16 w-full rounded-md border bg-background px-3 py-2 text-sm"
                                                    value={rating.manager_comment ?? ''}
                                                    onChange={(event) => onChange?.(index, 'manager_comment', event.target.value)}
                                                />
                                            </div>
                                        </div>
                                    ) : (
