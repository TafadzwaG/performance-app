    ...
    ({ className, asChild = false, ...props }, ref) => {
        ...
        return (
            <Comp
                ...
                className={cn(
                    'flex h-7 shrink-0 items-center rounded-md px-2 text-[0.6875rem] font-medium uppercase tracking-[0.08em] text-sidebar-foreground/70 outline-hidden ring-sidebar-ring transition-[margin,opa] duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-3.5 [&>svg]:shrink-0',
    ...
    ({ className, asChild = false, ...props }, ref) => {
        ...
        return (
            <Comp
                ...
                className={cn(
                    'absolute right-3 top-3 flex size-4 items-center justify-center rounded-md p-0 text-sidebar-foreground outline-hidden ring-sidebar-ring transition-transform hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 [&>svg]:size-3.5 [&>svg]:shrink-0',
...
const SidebarGroupContent = React.forwardRef<HTMLDivElement, React.ComponentProps<'div'>>(({ className, ...props }, ref) => (
    <div ref={ref} data-sidebar="group-content" className={cn('w-full text-[0.8125rem]', className)} {...props} />
));
    ...
    'peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md px-2 py-1.5 text-left text-[0.8125rem] outline-hidden ring-sidebar-ring transition-[width,height,padding] hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-data-[sidebar=menu-action]/menu-item:pr-7 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-sidebar-accent data-[active=true]:font-medium data-[active=true]:text-sidebar-accent-foreground data-[state=open]:hover:bg-sidebar-accent data-[state=open]:hover:text-sidebar-accent-foreground group-data-[collapsible=icon]:size-7! group-data-[collapsible=icon]:p-1.5! [&>span:last-child]:truncate [&>svg]:size-3.5 [&>svg]:shrink-0',
    {
        variants: {
            ...
            size: {
                ...
                sm: 'h-6 text-xs',
                lg: 'h-9 text-[0.8125rem] group-data-[collapsible=icon]:p-0!',
            },
        },
        defaultVariants: {
            variant: 'default',
...
>(({ className, asChild = false, showOnHover = false, ...props }, ref) => {
    ...
    return (
        <Comp
            ...
            className={cn(
                'absolute right-1 top-1.5 flex size-4 items-center justify-center rounded-md p-0 text-sidebar-foreground outline-hidden ring-sidebar-ring transition-transform hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 peer-hover/menu-button:text-sidebar-accent-foreground [&>svg]:size-3.5 [&>svg]:shrink-0',
                // Increases the hit area of the button on mobile.
                'after:absolute after:-inset-2 md:after:hidden',
...
const SidebarMenuBadge = React.forwardRef<HTMLDivElement, React.ComponentProps<'div'>>(({ className, ...props }, ref) => (
    <div
        ...
        className={cn(
            'pointer-events-none absolute right-1 flex h-4 min-w-4 select-none items-center justify-center rounded-md px-1 text-[0.6875rem] font-medium tabular-nums text-sidebar-foreground',
...
>(({ className, showIcon = false, ...props }, ref) => {
    ...
    return (
        <div ref={ref} data-sidebar="menu-skeleton" className={cn('flex h-6 items-center gap-2 rounded-md px-2', className)} {...props}>
            {showIcon && <Skeleton className="size-3.5 rounded-md" data-sidebar="menu-skeleton-icon" />}
            <Skeleton
